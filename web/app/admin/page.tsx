...
const TILES = [
  {
    href: "/admin/clinics",
    title: "Клиники и цены",
    desc: "Добавляйте и правьте клиники вручную, ведите их услуги и цены, исправляйте ошибки.",
  },
  {
    href: "/admin/import",
    title: "Импорт прайс-листа",
    desc: "Загрузка прайса из Excel, PDF, Word, HTML или по ссылке — с авто-распознаванием и правкой перед записью.",
  },
  {
    href: "/admin/parser",
